...
.method static getNTLM2SessionResponse(Ljava/lang/String;[B[B)[B
    ...
    invoke-static {v0, v2}, Lorg/apache/http/impl/auth/NTLMEngineImpl;->lmResponse([B[B)[B
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method private static ntlmv2Hash(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)[B
    ...
    invoke-direct {v1, v0}, Lorg/apache/http/impl/auth/NTLMEngineImpl$HMACMD5;-><init>([B)V
    ...
    invoke-virtual {v1, v0}, Lorg/apache/http/impl/auth/NTLMEngineImpl$HMACMD5;->update([B)V
