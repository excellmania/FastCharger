...
# instance fields
.field private a:Lcom/google/android/gms/c/no;
...
.method private a()V
    ...
    iget-object v0, p0, Lcom/google/android/gms/ads/AdActivity;->a:Lcom/google/android/gms/c/no;
    ...
    invoke-interface {v0}, Lcom/google/android/gms/c/no;->l()V
    :try_end_0
...
.method protected onActivityResult(IILandroid/content/Intent;)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lcom/google/android/gms/c/no;->a(IILandroid/content/Intent;)V
    :try_end_0
...
.method public onBackPressed()V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/google/android/gms/ads/AdActivity;->a:Lcom/google/android/gms/c/no;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/google/android/gms/ads/AdActivity;->a:Lcom/google/android/gms/c/no;

    invoke-interface {v1}, Lcom/google/android/gms/c/no;->e()Z
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-interface {v0, v1}, Lcom/google/android/gms/c/no;->a(Lcom/google/android/gms/a/a;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, p0}, Lcom/google/android/gms/c/he;->b(Landroid/app/Activity;)Lcom/google/android/gms/c/no;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/gms/ads/AdActivity;->a:Lcom/google/android/gms/c/no;
    ...
    invoke-interface {v0, p1}, Lcom/google/android/gms/c/no;->a(Landroid/os/Bundle;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected onDestroy()V
    ...
    invoke-interface {v0}, Lcom/google/android/gms/c/no;->k()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected onPause()V
    ...
    invoke-interface {v0}, Lcom/google/android/gms/c/no;->i()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected onRestart()V
    ...
    invoke-interface {v0}, Lcom/google/android/gms/c/no;->f()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected onResume()V
    ...
    invoke-interface {v0}, Lcom/google/android/gms/c/no;->h()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    invoke-interface {v0, p1}, Lcom/google/android/gms/c/no;->b(Landroid/os/Bundle;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected onStart()V
    ...
    invoke-interface {v0}, Lcom/google/android/gms/c/no;->g()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method protected onStop()V
    ...
    invoke-interface {v0}, Lcom/google/android/gms/c/no;->j()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
