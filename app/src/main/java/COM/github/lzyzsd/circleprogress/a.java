...
import hizli.batarya.sarjetme.app.R;

public final class a

     {
        public static final int[] ArcProgress = new int[]{R.attr.arc_progress, R.attr.arc_angle, R.attr.arc_stroke_width, R.attr.arc_max, R.attr.arc_unfinished_color, R.attr.arc_finished_color, R.attr.arc_text_size, R.attr.arc_text_color, R.attr.arc_suffix_text, R.attr.arc_suffix_text_size, R.attr.arc_suffix_text_padding, R.attr.arc_bottom_text, R.attr.arc_bottom_text_size, R.attr.arc_bottom_text_color};
        ...
        public static final int[] CircleProgress = new int[]{R.attr.circle_progress, R.attr.circle_max, R.attr.circle_unfinished_color, R.attr.circle_finished_color, R.attr.circle_text_size, R.attr.circle_text_color, R.attr.circle_prefix_text, R.attr.circle_suffix_text};
        ...
        public static final int[] Themes = new int[]{R.attr.circleProgressStyle, R.attr.donutProgressStyle, R.attr.arcProgressStyle};
