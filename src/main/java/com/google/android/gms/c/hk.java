...
public interface hk extends IInterface {
    ...
    public static abstract class a extends Binder implements hk {
        ...
        public static hk a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface queryLocalInterface = iBinder.queryLocalInterface("com.google.android.gms.ads.internal.client.IAdLoader");
            return (queryLocalInterface == null || !(queryLocalInterface instanceof hk)) ? new a(iBinder) : (hk) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    a(parcel.readInt() != 0 ? (gv) gv.CREATOR.createFromParcel(parcel) : null);
