...
public interface nw extends IInterface {
    ...
    public static abstract class a extends Binder implements nw {

        private static class a implements nw {
            private IBinder a;
        ...
        public static nw a(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof nw)) ? new a(iBinder) : (nw) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    a(com.google.android.gms.c.nv.a.a(parcel.readStrongBinder()));
