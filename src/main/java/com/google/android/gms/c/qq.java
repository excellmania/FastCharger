...
public interface qq extends IInterface {

    public static abstract class a extends Binder implements qq {

        private static class a implements qq {
            private IBinder a;
        ...
        public static qq a(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof qq)) ? new a(iBinder) : (qq) queryLocalInterface;
        }
