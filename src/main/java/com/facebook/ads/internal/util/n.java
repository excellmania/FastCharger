...
class n implements k {
        ...
        if (i6 == 1) {
            ...
            while (true) {
                ...
                if (i12 < i11) {
                    ...
                    j = j11;
                    while (i14 < i) {
                        iArr[i10] = (int) (((((long) (iArr[i10] & ViewCompat.MEASURED_STATE_MASK)) | ((((((long) s) * j9) >>> b) & 255) << 16)) | ((((((long) s) * j6) >>> b) & 255) << 8)) | (((((long) s) * j5) >>> b) & 255));
                        i16 = i10 + 1;
                        j9 -= j;
                        j6 -= j3;
                        j5 -= j2;
            ...
            for (i16 = (i5 * i) / i4; i16 < i11; i16++) {
                ...
                for (i10 = 0; i10 <= i3; i10++) {
                    iArr2[i10] = iArr[i16];
                    j9 += (long) (((iArr[i16] >>> 16) & 255) * (i10 + 1));
                    j6 += (long) (((iArr[i16] >>> 8) & 255) * (i10 + 1));
                    j5 += (long) ((iArr[i16] & 255) * (i10 + 1));
                ...
                for (i7 = 1; i7 <= i3; i7++) {
                    ...
                    j9 += (long) (((iArr[i10] >>> 16) & 255) * ((i3 + 1) - i7));
                    j6 += (long) (((iArr[i10] >>> 8) & 255) * ((i3 + 1) - i7));
                    j5 += (long) ((iArr[i10] & 255) * ((i3 + 1) - i7));
                    j4 += (long) ((iArr[i10] >>> 16) & 255);
                    j7 += (long) ((iArr[i10] >>> 8) & 255);
                    j8 += (long) (iArr[i10] & 255);
                }
                i10 = i3 > i8 ? i8 : i3;
                i7 = (i10 * i) + i16;
                i14 = i3;
    ...
    public Bitmap a(Bitmap bitmap, float f) {
        ...
        try {
            ...
            try {
                t.b.invokeAll(arrayList);
                try {
                    t.b.invokeAll(arrayList2);
                    try {
