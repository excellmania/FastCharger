...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements LayoutInflaterFactory, Callback {
    ...
    private final class ActionMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        /* synthetic */ ActionMenuPresenterCallback(AppCompatDelegateImplV9 appCompatDelegateImplV9, AnonymousClass1 anonymousClass1) {
            this();
        }
    ...
    private final class PanelMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        /* synthetic */ PanelMenuPresenterCallback(AppCompatDelegateImplV9 appCompatDelegateImplV9, AnonymousClass1 anonymousClass1) {
            this();
        }
        ...
        public void onCloseMenu(MenuBuilder menuBuilder, boolean z) {
            ...
            PanelFeatureState access$800 = appCompatDelegateImplV9.findMenuPanel(menuBuilder2);
            if (access$800 == null) {
                return;
            }
            if (z2) {
                AppCompatDelegateImplV9.this.callOnPanelClosed(access$800.featureId, access$800, rootMenu);
                AppCompatDelegateImplV9.this.closePanel(access$800, true);
                return;
            }
            AppCompatDelegateImplV9.this.closePanel(access$800, z);
        }
                ...
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(view, new OnApplyWindowInsetsListener() {
                        public WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
                            ...
                            int access$300 = AppCompatDelegateImplV9.this.updateStatusGuard(systemWindowInsetTop);
    ...
    /* JADX WARNING: Missing block: B:62:0x00ff, code skipped:
