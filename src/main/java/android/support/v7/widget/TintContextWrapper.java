...
public class TintContextWrapper extends ContextWrapper {
    ...
    private static boolean shouldWrap(@NonNull Context context) {
        return ((context instanceof TintContextWrapper) || (context.getResources() instanceof TintResources) || (context.getResources() instanceof VectorEnabledTintResources)) ? false : !AppCompatDelegate.isCompatVectorFromResourcesEnabled() || VERSION.SDK_INT <= 20;
    }
