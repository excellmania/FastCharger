...
public class NavigationMenuPresenter implements MenuPresenter {
                ...
                while (i3 < size) {
                    ...
                    if (menuItemImpl.hasSubMenu()) {
                        ...
                        if (subMenu.hasVisibleItems()) {
                            ...
                            this.mItems.add(new NavigationMenuTextItem(menuItemImpl, null));
                            Object obj = null;
                            ...
                            for (i5 = 0; i5 < size3; i5++) {
                                ...
                                if (menuItemImpl2.isVisible()) {
                                    ...
                                    this.mItems.add(new NavigationMenuTextItem(menuItemImpl2, null));
                                }
                            }
                            if (obj != null) {
                        ...
                        NavigationMenuTextItem navigationMenuTextItem = new NavigationMenuTextItem(menuItemImpl, null);
    ...
    private static class NavigationMenuHeaderItem implements NavigationMenuItem {
        ...
        /* synthetic */ NavigationMenuHeaderItem(AnonymousClass1 anonymousClass1) {
            this();
        }
    }
    ...
    private static class NavigationMenuTextItem implements NavigationMenuItem {
        ...
        /* synthetic */ NavigationMenuTextItem(MenuItemImpl menuItemImpl, AnonymousClass1 anonymousClass1) {
            this(menuItemImpl);
        }
