...
public interface mo extends IInterface {
    ...
    public static abstract class a extends Binder implements mo {
        ...
        private static class a implements mo {
            ...
            public mp a(String str) {
                ...
                try {
                    ...
                    mp a = com.google.android.gms.c.mp.a.a(obtain2.readStrongBinder());
                    return a;
                } finally {
                    obtain2.recycle();
                    obtain.recycle();
        ...
        public static mo a(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof mo)) ? new a(iBinder) : (mo) queryLocalInterface;
        }
