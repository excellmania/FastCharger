...
public interface mt extends IInterface {
    ...
    public static abstract class a extends Binder implements mt {

        private static class a implements mt {
            private IBinder a;
        ...
        public static mt a(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof mt)) ? new a(iBinder) : (mt) queryLocalInterface;
        }
