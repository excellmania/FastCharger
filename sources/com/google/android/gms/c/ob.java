...
public interface ob extends IInterface {
    ...
    public static abstract class a extends Binder implements ob {

        private static class a implements ob {
            private IBinder a;
        ...
        public static ob a(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof ob)) ? new a(iBinder) : (ob) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                ...
                case 2:
                    parcel.enforceInterface("com.google.android.gms.ads.internal.purchase.client.IPlayStorePurchaseListener");
                    a(com.google.android.gms.c.oa.a.a(parcel.readStrongBinder()));
                    parcel2.writeNoException();
                    return true;
                case 1598968902:
