...
public interface pq extends IInterface {
    ...
    public static abstract class a extends Binder implements pq {

        private static class a implements pq {
            private IBinder a;
        ...
        public static pq a(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof pq)) ? new a(iBinder) : (pq) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            switch (i) {
                case 1:
                    ...
                    a(parcel.readInt() != 0 ? (pj) pj.CREATOR.createFromParcel(parcel) : null);
