...
public interface mr extends IInterface {
    ...
    public static abstract class a extends Binder implements mr {

        private static class a implements mr {
            private IBinder a;
        ...
        public static mr a(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof mr)) ? new a(iBinder) : (mr) queryLocalInterface;
        }
