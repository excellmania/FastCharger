...
public interface jv extends IInterface {
    ...
    public static abstract class a extends Binder implements jv {

        private static class a implements jv {
            private IBinder a;
        ...
        public static jv a(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof jv)) ? new a(iBinder) : (jv) queryLocalInterface;
        }
