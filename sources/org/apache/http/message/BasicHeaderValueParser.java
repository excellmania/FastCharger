...
public class BasicHeaderValueParser implements HeaderValueParser {
    ...
    public NameValuePair parseNameValuePair(CharArrayBuffer charArrayBuffer, ParserCursor parserCursor, char[] cArr) {
        ...
        if (charArrayBuffer == null) {
            ...
            pos2 = i;
            while (pos2 > i2 && HTTP.isWhitespace(charArrayBuffer.charAt(pos2 - 1))) {
                pos2--;
            }
            if (pos2 - i2 >= 2 && charArrayBuffer.charAt(i2) == '\"' && charArrayBuffer.charAt(pos2 - 1) == '\"') {
                i2++;
                pos2--;
            }
            String substring = charArrayBuffer.substring(i2, pos2);
            parserCursor.updatePos(obj != null ? i + 1 : i);
