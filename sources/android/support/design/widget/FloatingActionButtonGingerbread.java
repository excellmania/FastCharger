...
class FloatingActionButtonGingerbread extends FloatingActionButtonImpl {
    ...
    private class DisabledElevationAnimation extends ShadowAnimatorImpl {
        private DisabledElevationAnimation() {
            super(FloatingActionButtonGingerbread.this, null);
        }

        /* synthetic */ DisabledElevationAnimation(FloatingActionButtonGingerbread floatingActionButtonGingerbread, AnonymousClass1 anonymousClass1) {
            this();
        }
    ...
    private class ElevateToTranslationZAnimation extends ShadowAnimatorImpl {
        ...
        /* synthetic */ ElevateToTranslationZAnimation(FloatingActionButtonGingerbread floatingActionButtonGingerbread, AnonymousClass1 anonymousClass1) {
            this();
        }
    ...
    private class ResetElevationAnimation extends ShadowAnimatorImpl {
        ...
        /* synthetic */ ResetElevationAnimation(FloatingActionButtonGingerbread floatingActionButtonGingerbread, AnonymousClass1 anonymousClass1) {
            this();
        }
    ...
    FloatingActionButtonGingerbread(VisibilityAwareImageButton visibilityAwareImageButton, ShadowViewDelegate shadowViewDelegate, Creator creator) {
        ...
        this.mStateListAnimator.addState(PRESSED_ENABLED_STATE_SET, createAnimator(new ElevateToTranslationZAnimation(this, null)));
        this.mStateListAnimator.addState(FOCUSED_ENABLED_STATE_SET, createAnimator(new ElevateToTranslationZAnimation(this, null)));
        this.mStateListAnimator.addState(ENABLED_STATE_SET, createAnimator(new ResetElevationAnimation(this, null)));
        this.mStateListAnimator.addState(EMPTY_STATE_SET, createAnimator(new DisabledElevationAnimation(this, null)));
    }
