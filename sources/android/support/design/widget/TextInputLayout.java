...
public class TextInputLayout extends LinearLayout {
    ...
    private class TextInputAccessibilityDelegate extends AccessibilityDelegateCompat {
        ...
        /* synthetic */ TextInputAccessibilityDelegate(TextInputLayout textInputLayout, AnonymousClass1 anonymousClass1) {
            this();
        }
    ...
    private void updateLabelState(boolean z) {
        ...
        if (obj2 != null || (isEnabled() && (arrayContains || obj != null))) {
            collapseHint(z);
        } else {
            expandHint(z);
        }
    ...
    private void updatePasswordToggleView() {
        ...
        if (shouldShowPasswordIcon()) {
            ...
            TextViewCompat.setCompoundDrawablesRelative(this.mEditText, compoundDrawablesRelative[0], compoundDrawablesRelative[1], this.mPasswordToggleDummyDrawable, compoundDrawablesRelative[2]);
        ...
        compoundDrawablesRelative = TextViewCompat.getCompoundDrawablesRelative(this.mEditText);
        TextViewCompat.setCompoundDrawablesRelative(this.mEditText, compoundDrawablesRelative[0], compoundDrawablesRelative[1], null, compoundDrawablesRelative[2]);
    }
        ...
        if (this.mCounterEnabled != z) {
            if (z) {
                ...
                try {
                    ...
                    this.mCounterView.setTextAppearance(getContext(), android.support.v7.appcompat.R.style.TextAppearance_AppCompat_Caption);
        ...
        if (this.mErrorEnabled != z) {
            ...
            if (z) {
                ...
                try {
                    ...
                    this.mErrorView.setTextAppearance(getContext(), android.support.v7.appcompat.R.style.TextAppearance_AppCompat_Caption);
