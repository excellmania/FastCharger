...
public class StaggeredGridLayoutManager extends LayoutManager implements ScrollVectorProvider {
    ...
    class Span {
        ...
        /* synthetic */ Span(StaggeredGridLayoutManager staggeredGridLayoutManager, int i, AnonymousClass1 anonymousClass1) {
            this(i);
        }
    ...
    L_0x003d:
        r0 = r3.mLayoutFromEnd;
        r4 = r8.mLastLayoutFromEnd;
        if (r0 != r4) goto L_0x004b;
    L_0x0043:
        r0 = r8.isLayoutRTL();
        r4 = r8.mLastLayoutRTL;
        if (r0 == r4) goto L_0x0052;
    L_0x004b:
        r0 = r8.mLazySpanLookup;
        r0.clear();
    ...
    L_0x005c:
        r0 = r8.mPendingSavedState;
        r0 = r0.mSpanOffsetsSize;
        if (r0 >= r2) goto L_0x009f;
    L_0x0062:
        r0 = r3.mInvalidateOffsets;
    ...
    private void updateLayoutState(int r7, android.support.v7.widget.RecyclerView.State r8) {
        /*
        r6 = this;
        r3 = 1;
        r1 = 0;
        ...
        r0 = r6.isSmoothScrolling();
        if (r0 == 0) goto L_0x007c;
    L_0x0010:
        r0 = r8.getTargetScrollPosition();
        r2 = -1;
        if (r0 == r2) goto L_0x007c;
    L_0x0017:
        r2 = r6.mShouldReverseLayout;
    ...
    L_0x001e:
        ...
        r2 = r1;
    L_0x0025:
        r4 = r6.getClipToPadding();
        if (r4 == 0) goto L_0x006b;
    L_0x002b:
        r4 = r6.mLayoutState;
        r5 = r6.mPrimaryOrientation;
        r5 = r5.getStartAfterPadding();
        r2 = r5 - r2;
        r4.mStartLine = r2;
        r2 = r6.mLayoutState;
        r4 = r6.mPrimaryOrientation;
