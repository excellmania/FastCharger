    ...
    private static ColorStateList inflate(@NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Theme theme) {
        ...
        while (true) {
            ...
            if (depth2 < depth && next == 3) {
                ...
                append = GrowingArrayUtils.append(iArr, i, next);
                i++;
        ...
        append = new int[i];
        int[][] iArr3 = new int[i][];
        System.arraycopy(iArr, 0, append, 0, i);
        System.arraycopy(objArr2, 0, iArr3, 0, i);
        return new ColorStateList(iArr3, append);
    }
